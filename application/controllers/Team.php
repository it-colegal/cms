...
class Team extends CI_Controller
{
    ...
    public function index()
    {
        ...
        */
        ...
        $data['description'] =
            'Kenali para profesional berpengalaman di balik layanan dan solusi terbaik yang kami hadirkan.';

        $data['keywords'] = 'tim, anggota, profesional';
        ...
        */
        ...
        $data['team'] = $this->Team_model->get_published(
            $per_page,
            $offset
        );
