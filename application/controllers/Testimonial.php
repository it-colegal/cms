...
class Testimonial extends CI_Controller
{
    ...
    public function index()
    {
        ...
        */
        ...
        $data['description'] =
            'Apa yang dikatakan klien kami tentang layanan dan produk yang telah kami berikan.';

        $data['keywords'] = 'testimoni, ulasan, klien';
        ...
        */
        ...
        $data['testimonials'] = $this->Testimonial_model->get_published(
            $per_page,
            $offset
        );
