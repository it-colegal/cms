...
class Client extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = 'Klien';
        $data['description'] = 'Perusahaan-perusahaan terpercaya yang telah bermitra dengan kami.';
        $data['keywords'] = 'klien, partner, perusahaan';
        $data['image'] = '';
        ...
        $data['clients'] = $this->Client_model->get_published($per_page, $offset);
        ...
        if ($this->input->is_ajax_request()) {
            $this->load->view('frontend/client/list', $data);
            return;
        }
